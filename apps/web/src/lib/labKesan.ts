...
export const PAKET_PEMERIKSAAN_LAB: readonly LabPackage[] = [
  ...
  },
  {
    ...
    label: 'Urinalisa',
    items: [
      { pemeriksaan: 'Warna', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Kuning Muda - Kuning' },
      { pemeriksaan: 'Kejernihan', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Jernih' },
      { pemeriksaan: 'LEU', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif' },
      { pemeriksaan: 'NIT', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif' },
      { pemeriksaan: 'PRO', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif' },
      { pemeriksaan: 'URO', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Normal' },
      { pemeriksaan: 'pH', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: '4,5 - 8,0' },
      { pemeriksaan: 'BLO', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif' },
      { pemeriksaan: 'SG', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: '1,005 - 1,030' },
      { pemeriksaan: 'KET', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif' },
      { pemeriksaan: 'BIL', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif' },
      { pemeriksaan: 'GLU', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif' },
