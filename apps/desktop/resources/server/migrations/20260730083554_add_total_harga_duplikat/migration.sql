...
INSERT INTO "new_PasienDuplikat" ("alamat", "archivedAt", "asalModul", "hasilStatus", "id", "kesan", "klinis", "nama", "noTelepon", "paymentStatus", "pemeriksaanNama", "pengirimNama", "radiologNama", "regCode", "registeredAt", "sourcePasienId", "tanggalLahir", "updatedAt") SELECT "alamat", "archivedAt", "asalModul", "hasilStatus", "id", "kesan", "klinis", "nama", "noTelepon", "paymentStatus", "pemeriksaanNama", "pengirimNama", "radiologNama", "regCode", "registeredAt", "sourcePasienId", "tanggalLahir", "updatedAt" FROM "PasienDuplikat";
