...
CREATE TABLE "new_LaporanNeraca" (
    ...
    "biayaPajakSewa" DECIMAL NOT NULL DEFAULT 0,
...
INSERT INTO "new_LaporanNeraca" ("bank", "biayaAtkBahan", "biayaGaji", "biayaLainLain", "biayaListrik", "biayaSewa", "biayaTelpon", "biayaTransport", "createdAt", "gedung", "id", "kas", "kendaraan", "logoPerusahaanId", "modalUsaha", "modul", "namaPenandatangan", "namaPerusahaan", "pendapatan", "peralatan", "persediaan", "piutang", "tanah", "tanggalTandaTangan", "tempatTandaTangan", "updatedAt", "utangJangkaPanjang", "utangLainnya", "utangPajak", "utangUsaha", "year") SELECT "bank", "biayaAtkBahan", "biayaGaji", "biayaLainLain", "biayaListrik", "biayaSewa", "biayaTelpon", "biayaTransport", "createdAt", "gedung", "id", "kas", "kendaraan", "logoPerusahaanId", "modalUsaha", "modul", "namaPenandatangan", "namaPerusahaan", "pendapatan", "peralatan", "persediaan", "piutang", "tanah", "tanggalTandaTangan", "tempatTandaTangan", "updatedAt", "utangJangkaPanjang", "utangLainnya", "utangPajak", "utangUsaha", "year" FROM "LaporanNeraca";
