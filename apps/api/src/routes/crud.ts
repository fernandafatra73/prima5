  ...
  app.post('/api/paket-lab/init-defaults', async () => {
    const defaultSeed = [
      ...
      },
      {
        ...
        harga: 75000,
        items: [
          { pemeriksaan: 'Warna', grup: 'Makroskopis', nilaiRujukan: 'Kuning Muda - Kuning', satuan: '-', harga: 3000, urutan: 1 },
          { pemeriksaan: 'Kejernihan', grup: 'Makroskopis', nilaiRujukan: 'Jernih', satuan: '-', harga: 3000, urutan: 2 },
          { pemeriksaan: 'LEU', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 3 },
          { pemeriksaan: 'NIT', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 4 },
          { pemeriksaan: 'PRO', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 5 },
          { pemeriksaan: 'URO', grup: 'Makroskopis', nilaiRujukan: 'Normal', satuan: '-', harga: 5000, urutan: 6 },
          { pemeriksaan: 'pH', grup: 'Makroskopis', nilaiRujukan: '4,5 - 8,0', satuan: '-', harga: 5000, urutan: 7 },
          { pemeriksaan: 'BLO', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 8 },
          { pemeriksaan: 'SG', grup: 'Makroskopis', nilaiRujukan: '1,005 - 1,030', satuan: '-', harga: 5000, urutan: 9 },
          { pemeriksaan: 'KET', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 10 },
          { pemeriksaan: 'BIL', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 11 },
          { pemeriksaan: 'GLU', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 12 },
