  ...
  app.post('/api/paket-lab/init-defaults', async () => {
    const defaultSeed = [
      ...
      },
      {
        ...
        harga: 75000,
        items: [
          { pemeriksaan: 'LEU', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 1 },
          { pemeriksaan: 'NIT', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 2 },
          { pemeriksaan: 'PRO', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 3 },
          { pemeriksaan: 'URO', grup: 'Makroskopis', nilaiRujukan: 'Normal', satuan: '-', harga: 5000, urutan: 4 },
          { pemeriksaan: 'pH', grup: 'Makroskopis', nilaiRujukan: '4,5 - 8,0', satuan: '-', harga: 5000, urutan: 5 },
          { pemeriksaan: 'BLO', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 6 },
          { pemeriksaan: 'SG', grup: 'Makroskopis', nilaiRujukan: '1,005 - 1,030', satuan: '-', harga: 5000, urutan: 7 },
          { pemeriksaan: 'KET', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 8 },
          { pemeriksaan: 'BIL', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 9 },
          { pemeriksaan: 'GLU', grup: 'Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 10 },
          { pemeriksaan: 'Eritrosit (RBC)', grup: 'Sedimen', nilaiRujukan: '0 - 2 /LPB', satuan: '/LPB', harga: 3000, urutan: 11 },
          { pemeriksaan: 'Leukosit (WBC)', grup: 'Sedimen', nilaiRujukan: '0 - 5 /LPB', satuan: '/LPB', harga: 3000, urutan: 12 },
          { pemeriksaan: 'Epitel', grup: 'Sedimen', nilaiRujukan: 'Positif (+)', satuan: '-', harga: 3000, urutan: 13 },
          { pemeriksaan: 'Bakteri', grup: 'Sedimen', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 14 },
          { pemeriksaan: 'Kristal', grup: 'Sedimen', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 15 },
          { pemeriksaan: 'Silinder (Casts)', grup: 'Sedimen', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 16 },
          { pemeriksaan: 'Jamur/Yeast', grup: 'Sedimen', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 17 },
          { pemeriksaan: 'Trichomonas', grup: 'Sedimen', nilaiRujukan: 'Negatif (bila ditemukan)', satuan: '-', harga: 3000, urutan: 18 },
          { pemeriksaan: 'Mucus/Thread', grup: 'Sedimen', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 19 },
        ],
      },
      {
        nama: 'Urin rutin',
