  ...
  app.post('/api/paket-lab/init-defaults', async () => {
    const defaultSeed = [
      ...
      },
      {
        ...
        harga: 75000,
        items: [
          { pemeriksaan: 'Warna', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Kuning Muda - Kuning', satuan: '-', harga: 3000, urutan: 1 },
          { pemeriksaan: 'Kejernihan', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Jernih', satuan: '-', harga: 3000, urutan: 2 },
          { pemeriksaan: 'LEU', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 3 },
          { pemeriksaan: 'NIT', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 4 },
          { pemeriksaan: 'PRO', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 5 },
          { pemeriksaan: 'URO', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Normal', satuan: '-', harga: 5000, urutan: 6 },
          { pemeriksaan: 'pH', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: '4,5 - 8,0', satuan: '-', harga: 5000, urutan: 7 },
          { pemeriksaan: 'BLO', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 8 },
          { pemeriksaan: 'SG', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: '1,005 - 1,030', satuan: '-', harga: 5000, urutan: 9 },
          { pemeriksaan: 'KET', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 10 },
          { pemeriksaan: 'BIL', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 11 },
          { pemeriksaan: 'GLU', grup: 'Urine Rutin - Makroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 5000, urutan: 12 },
          { pemeriksaan: 'Sedimen Urine', grup: 'Mikroskopis', nilaiRujukan: '-', satuan: '-', harga: 3000, urutan: 13 },
          { pemeriksaan: 'Eritrosit (RBC)', grup: 'Mikroskopis', nilaiRujukan: '0 - 2 /LPB', satuan: '/LPB', harga: 3000, urutan: 14 },
          { pemeriksaan: 'Leukosit (WBC)', grup: 'Mikroskopis', nilaiRujukan: '0 - 5 /LPB', satuan: '/LPB', harga: 3000, urutan: 15 },
          { pemeriksaan: 'Epitel', grup: 'Mikroskopis', nilaiRujukan: 'Positif (+)', satuan: '-', harga: 3000, urutan: 16 },
          { pemeriksaan: 'Bakteri', grup: 'Mikroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 17 },
          { pemeriksaan: 'Kristal', grup: 'Mikroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 18 },
          { pemeriksaan: 'Silinder (Casts)', grup: 'Mikroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 19 },
          { pemeriksaan: 'Jamur/Yeast', grup: 'Mikroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 20 },
          { pemeriksaan: 'Trichomonas', grup: 'Mikroskopis', nilaiRujukan: 'Negatif (bila ditemukan)', satuan: '-', harga: 3000, urutan: 21 },
          { pemeriksaan: 'Mucus/Thread', grup: 'Mikroskopis', nilaiRujukan: 'Negatif', satuan: '-', harga: 3000, urutan: 22 },
        ],
      },
      {
        nama: 'Urin rutin',
